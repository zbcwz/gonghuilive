<template>
  <div class="liveRoomBottom">
    ...
    <!-- <van-cell-group> -->
      <van-field
        class="liveRoomBottomField"
        v-model="commentValue"
        center
        clearable
        :readonly="wsConnected == false "
  ...
  export default{
    ...
    computed: {
      ...
      isQlgh(){
        ...
        if(this.$store.state.qlghUser){
          if(!this.$store.state.qlghUser.userPhone || this.$store.state.qlghUser.userId == -1 ){
            return false;
          }
        }
